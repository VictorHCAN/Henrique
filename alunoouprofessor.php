...
<body>
    ...
    <div class="wrapper">
        ...
        <form id="student-form" class="login-form" action="testLogin.php" method="POST">
            <div class="input-box">
                <input type="text" id="student-email" name="email" placeholder="Email do aluno" required>
                <i class="bx bxs-user"></i>
            </div>
            <div class="input-box">
                <input type="password" id="student-password" name="senha" placeholder="Senha" required>
                <i class="bx bxs-lock-alt"></i>
            </div>
            <div class="remember-forgot">
                <label><input type="checkbox"> Lembra-se de mim </label>
        ...
        <div class="student-info" id="student-info">
            ...
            <p>Nome: <span id="student-name"></span></p>
            <p>Idade: <span id="student-age"></span></p>
